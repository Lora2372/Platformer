...
public class CreateDoodad 
{
	...
	public CreateDoodad(TileMap tileMap)
	{
		...
		{
			ArrayList<DoodadData> tempList = new ArrayList<DoodadData>();
	...
	public static void addDoodad(String currentMap, DoodadData doodadData)
	{
	...
	public static ArrayList<DoodadData> getDoodadDataList(String map)
	{
	...
	public static HashMap<String, ArrayList<DoodadData>> doodads  = new HashMap<String, ArrayList<DoodadData>>();
}
