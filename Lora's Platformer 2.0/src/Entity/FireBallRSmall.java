...
import Entity.Doodad.FireBallRSmallExplosion;
import GameState.MainMap;
import Main.Content;
import TileMap.TileMap;

public class FireBallRSmall extends Projectile
{
	protected FireBallRSmallExplosion fireBallSmallExplosion;
	
	public FireBallRSmall(
			TileMap tileMap,
			MainMap mainMap,
			boolean right, 
			boolean up, 
	...
	public void setProjectile()
	{
		...
		{
			fireBallSmallExplosion = new FireBallRSmallExplosion(tileMap, x, y);
		}
