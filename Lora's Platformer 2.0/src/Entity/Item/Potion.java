...
public class Potion extends Item
{
	...
	public void setItem()
	{
		if(itemType.equals(ItemData.Potions.Healing.toString()))
		{
			sprites = Content.PotionHealth[0];
			portrait = Content.PortraitPotionHealing[0];
		}
		else if(itemType.equals(ItemData.Potions.Mana.toString()))
		{
			sprites = Content.PotionMana[0];
			portrait = Content.PortraitPotionMana[0];
		}
		else if(itemType.equals(ItemData.Potions.Stamina.toString()))
		{
