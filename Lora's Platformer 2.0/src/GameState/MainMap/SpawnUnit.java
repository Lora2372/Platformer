...
{	
	...
	Slug slug = new Slug(mainMap.tileMap, facingRight, friendly, untouchable, invulnerable, unkillable, name, spawnLocationX, spawnLocationY, mainMap, mainMap.currentMap);
	...
	)
{
	...
	Succubus succubus = new Succubus(mainMap.tileMap, facingRight, friendly, untouchable, invulnerable, unkillable, name, spawnLocationX, spawnLocationY, mainMap, mainMap.currentMap);
	...
	)
{
	...
	Wolf wolf = new Wolf(mainMap.tileMap, facingRight, friendly, untouchable, invulnerable, unkillable, name, spawnLocationX, spawnLocationY, mainMap, mainMap.currentMap);
...
{
	Skeleton skeleton = new Skeleton(mainMap.tileMap, facingRight, false, false, false, false, "Jesse Cox", locationX, locationY, mainMap, currentMap);
